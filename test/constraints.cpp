...
static_assert(is_defined<if_greater_size<int16_t, int8_t>>);
static_assert(is_defined<if_greater_size<int32_t, int8_t>>);
static_assert(is_defined<if_greater_size<int64_t, int8_t>>);
...
static_assert(is_defined<if_not_greater_size<uint8_t, char>>);
static_assert(is_defined<if_not_greater_size<uint16_t, wchar_t>>);
static_assert(is_defined<if_not_greater_size<uint16_t, int>>);
static_assert(is_defined<if_not_greater_size<short, int>>);
static_assert(is_defined<if_not_greater_size<uint16_t, short>>);
static_assert(is_defined<if_not_greater_size<int, long>>);
static_assert(is_defined<if_not_greater_size<long, long long>>);
static_assert(is_defined<if_not_greater_size<uint32_t, long>>);
static_assert(is_defined<if_not_greater_size<int32_t, int>>);
static_assert(is_defined<if_not_greater_size<int8_t, int8_t>>);
static_assert(is_defined<if_not_greater_size<uint8_t, uint8_t>>);
static_assert(is_defined<if_not_greater_size<int16_t, uint16_t>>);
static_assert(is_defined<if_not_greater_size<uint16_t, int16_t>>);
static_assert(is_defined<if_not_greater_size<int32_t, uint32_t>>);
...
////static_assert(!is_defined<if_not_greater_size<int32_t, int16_t>>);
////static_assert(!is_defined<if_not_greater_size<int64_t, int16_t>>);
////static_assert(!is_defined<if_not_greater_size<int64_t, int32_t>>);

static_assert(is_defined<if_common<signed int>>);
static_assert(is_defined<if_common<unsigned int>>);
static_assert(is_defined<if_common<int32_t>>);
static_assert(is_defined<if_common<uint32_t>>);
static_assert(is_defined<if_common<int64_t>>);
static_assert(is_defined<if_common<uint64_t>>);
////static_assert(!is_defined<if_common<int8_t>>);
////static_assert(!is_defined<if_common<uint8_t>>);
////static_assert(!is_defined<if_common<int16_t>>);
...
static_assert(is_defined<if_unsigned_integer<uintx>>);
...
static_assert(is_defined<if_same_signed_integer<uintx, uint128_t>>);
...
static_assert(is_defined<if_uintx<uint5_t>>);
static_assert(is_defined<if_uintx<uint11_t>>);
static_assert(is_defined<if_uintx<uint48_t>>);
static_assert(is_defined<if_uintx<uint128_t>>);
static_assert(is_defined<if_uintx<uint160_t>>);
static_assert(is_defined<if_uintx<uint256_t>>);
static_assert(is_defined<if_uintx<uint512_t>>);
////static_assert(!is_defined<if_uintx<uint8_t>>);
////static_assert(!is_defined<if_uintx<uint16_t>>);
////static_assert(!is_defined<if_uintx<uint32_t>>);
////static_assert(!is_defined<if_uintx<uint64_t>>);
////static_assert(!is_defined<if_uintx<size_t>>);
////static_assert(!is_defined<if_uintx<int8_t>>);
////static_assert(!is_defined<if_uintx<int16_t>>);
////static_assert(!is_defined<if_uintx<int32_t>>);
////static_assert(!is_defined<if_uintx<int64_t>>);
////static_assert(!is_defined<if_uintx<signed_size_t>>);
...
////static_assert(!is_defined<if_same_signed_integral_integer<char, bool>>);
////static_assert(!is_defined<if_same_signed_integral_integer<int, bool>>);
////static_assert(!is_defined<if_same_signed_integral_integer<float, bool>>);
////static_assert(!is_defined<if_same_signed_integral_integer<double, bool>>);
////static_assert(!is_defined<if_same_signed_integral_integer<int16_t, bool>>);
////static_assert(!is_defined<if_same_signed_integral_integer<int32_t, bool>>);
////static_assert(!is_defined<if_same_signed_integral_integer<int64_t, bool>>);
////static_assert(!is_defined<if_same_signed_integral_integer<base, bool>>);

static_assert(is_defined<if_same_signed_integral_integer<char, char>>);
static_assert(is_defined<if_same_signed_integral_integer<int, int>>);
static_assert(is_defined<if_same_signed_integral_integer<int, int16_t>>);
static_assert(is_defined<if_same_signed_integral_integer<int, int32_t>>);
static_assert(is_defined<if_same_signed_integral_integer<int, int64_t>>);
////static_assert(!is_defined<if_same_signed_integral_integer<char, uint16_t>>);
////static_assert(!is_defined<if_same_signed_integral_integer<char, size_t>>);
////static_assert(!is_defined<if_same_signed_integral_integer<char, float>>);
////static_assert(!is_defined<if_same_signed_integral_integer<char, double>>);
////static_assert(!is_defined<if_same_signed_integral_integer<char, base>>);
...
static_assert(is_defined<if_not_same_signed_integral_integer<uint8_t, signed char>>);
static_assert(is_defined<if_not_same_signed_integral_integer<uint16_t, int>>);
...
////static_assert(!is_defined<if_not_same_signed_integral_integer<char, int>>);
////static_assert(!is_defined<if_not_same_signed_integral_integer<int, int>>);
////static_assert(!is_defined<if_not_same_signed_integral_integer<float, int>>);
////static_assert(!is_defined<if_not_same_signed_integral_integer<double, int>>);
////static_assert(!is_defined<if_not_same_signed_integral_integer<int16_t, int>>);
