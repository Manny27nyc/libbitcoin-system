...
BOOST_AUTO_TEST_CASE(byte_flipper__get_write_position___stream_end__expected)
{
    std::stringstream stream{};
...
BOOST_AUTO_TEST_CASE(byte_flipper__get_read_position__read_and_reset__expected)
{
    std::stringstream stream{ "*" };
    flip::bytes::iostream reader(stream);
...
BOOST_AUTO_TEST_CASE(byte_flipper__skip_byte__default_empty__invalid)
{
    std::stringstream stream;
    flip::bytes::iostream reader(stream);
    reader.skip_byte();
...
BOOST_AUTO_TEST_CASE(byte_flipper__skip_byte__default_single__exhausted)
{
    std::stringstream stream{ "*" };
    flip::bytes::iostream reader(stream);
    reader.skip_byte();
...
BOOST_AUTO_TEST_CASE(byte_flipper__skip_bytes__end__exhausted)
{
    const auto size = 42;
...
BOOST_AUTO_TEST_CASE(byte_flipper__skip_bytes__past_end__invalid)
{
    const auto size = 42;
    std::stringstream stream{ std::string(size, 0x00) };
    flip::bytes::iostream reader(stream);
...
BOOST_AUTO_TEST_CASE(byte_flipper__skip_variable__empty__invalid)
{
    std::stringstream stream;
    flip::bytes::iostream reader(stream);
...
BOOST_AUTO_TEST_CASE(byte_flipper__skip_variable__one_end__exhausted)
{
...
BOOST_AUTO_TEST_CASE(byte_flipper__skip_variable__two_end__exhausted)
{
...
BOOST_AUTO_TEST_CASE(byte_flipper__skip_variable__four_end__exhausted)
{
...
BOOST_AUTO_TEST_CASE(byte_flipper__skip_variable__eight_end__exhausted)
{
...
BOOST_AUTO_TEST_CASE(byte_flipper__skip_variable__eight_from_nine__expected)
{
